...
package com.Rhythm.musicr.ui.page.subpages.singleplaylist;
...
public class SinglePlaylistCardLayerFragment_ViewBinding implements Unbinder {
  ...
  @UiThread
  public SinglePlaylistCardLayerFragment_ViewBinding(final SinglePlaylistCardLayerFragment target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SinglePlaylistCardLayerFragment target = this.target;
